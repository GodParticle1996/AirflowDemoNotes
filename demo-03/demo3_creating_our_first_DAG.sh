...
# Now goto the "Graph View" here we see one operator called "hello_world_task" which is a BashOperator. Next we can click on "Details" to see all the details.cfg
