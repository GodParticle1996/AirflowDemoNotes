...
# Goto "Graph View" observe here we have taskA with is the upstream followed by taskB which is the downstream been set ie first taskA is executed then taskB is executed
