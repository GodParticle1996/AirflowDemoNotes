...
# Note: The only changes to the code are we have explicitly specified the key for our Xcom pushes and pulls. And at determine_branch be are specifying the task_ids by mentioning the task group followed by task id
